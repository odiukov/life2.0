...
GARMIN_ROWS=$(docker compose exec -T postgres psql -U "$(grep POSTGRES_USER /Users/oleksandr/Documents/life-agents/.env | cut -d= -f2)" -d "$(grep POSTGRES_DB /Users/oleksandr/Documents/life-agents/.env | cut -d= -f2)" -tAc \
