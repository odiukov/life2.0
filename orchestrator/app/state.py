...
Consumed by the /chat/stream SSE handler to derive AgentRouted/AgentConsulted events.
...
class ToolCall(TypedDict):
    ...
    consultedPeers: NotRequired[list[str]]
...
class HealthAgentState(TypedDict):
    ...
    userId: NotRequired[Annotated[str | None, _take_last]]
    userTimezone: NotRequired[Annotated[str | None, _take_last]]
