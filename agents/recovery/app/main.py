...
from .executor import RecoveryAgentExecutor
...
def _build_a2a_app() -> A2AStarletteApplication:
    handler = DefaultRequestHandler(
        agent_executor=RecoveryAgentExecutor(),
        task_store=PostgresTaskStore(agent="recovery"),
    )
